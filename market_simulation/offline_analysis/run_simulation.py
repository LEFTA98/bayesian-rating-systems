...
class SimRunner:
    ...
    def generate_new_data_from_simulations(self,
                                           input_df: pd.DataFrame,
                                           products: List[str],
                                           weights: np.ndarray,
                                           priors: np.ndarray,
        ...
        df_to_return = {'timestep': [], 'prod': [], 'rating': []}
        ...
        for t in range_to_iterate:
            ...
            for m in range(num_users):
                ...
                df_to_return['timestep'].append(t)
                df_to_return['prod'].append(copy.deepcopy(helper.mkt_ids[a]))
                df_to_return['rating'].append(like)
